...
@implementation NSObject (JFTSwizzleBlock)
...
+ (NSInvocation*)jft_swizzleMethod:(SEL)origSel withBlock:(id)block error:(NSError**)error {
    ...
    NSString *blockSelectorString = [NSString stringWithFormat:@"_dov_block_%@_%p", NSStringFromSelector(origSel), block];
    ...
    [self jft_swizzleMethod:origSel withMethod:blockSel error:nil];
